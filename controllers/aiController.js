...
export const getAiExecutiveSummary = async (req, res) => {
    try {
        ...
        const prompt = `
            ...
            - Total Event Bookings: ${eventBookings}
            - Recent Food Orders: ${foodOrders.length} orders in last batch.
            ...
            2. The JSON should have these keys:
               ...
               - "pillars": {
                   ...
                   "guestExperience": (Detailed multi-paragraph analysis of order trends, event popularity, and guest engagement in Sinhala)
                 }
